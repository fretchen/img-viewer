...
class ImageDB(db.Model):
    ...
    def __init__(self, path, machine=[], year = 0, month = 0, day = 0):
        ...
        mtime = datetime.datetime.fromtimestamp(timestamp).time();
        self.date = datetime.date(self.year, self.month, self.day);
        self.date_time = datetime.datetime(self.year, self.month, self.day, mtime.hour, mtime.minute, mtime.second);
